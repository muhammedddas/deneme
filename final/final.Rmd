...
<!-- ============================== NOTLAR ================================= -->
<!-- ======================================================================= -->
[^1]: 20080270, [Github Repo](https://github.com/KULLANICI_ADINIZ/REPO_ADINIZ)
...
survey %>%
  select("Illiterate","Literate with no degree","Literate with no degree", "Less than high school","High school or equivalent", "Higher education", "Illiterate" ) %>% 
